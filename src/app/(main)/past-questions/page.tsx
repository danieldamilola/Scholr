            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="h-8 px-3 text-xs border border-border rounded-md text-ink-soft hover:bg-subtle disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
                  Previous
                </button>
                <button
